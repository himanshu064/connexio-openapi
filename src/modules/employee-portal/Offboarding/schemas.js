...
const MyOffboardingTableSchema = {
...
const MyOffboardings = {
  type: "array",
  $ref: "#/components/schemas/MyOffboardingTableSchema",
};

const OffboardingFunnelFormSchema = {
  title: "",
  type: "object",
  properties: {
    name: {
...
const OffboardingFunnelTableSchema = {
  type: "OffboardingFunnel",
  columns: [
    {
      type: "int",
      label: "ID",
...
const OffboardingFunnels = {
  type: "array",
  $ref: "#/components/schemas/OffboardingFunnelTableSchema",
};

const AssignOffboardingFunnelToEmployeeFormSchema = {
  title: "",
  type: "object",
  properties: {
    employee: {
...
const OffboardingFunnelTasksSubscriptionTableSchema = {
  type: "TaskFunnelSubscription",
  columns: [
    {
      type: "int",
      label: "ID",
  ...
  primary_key: "id",
  search: false,
  title: "Tasks of ed - copied",
};

const OffboardingFunnelTasksSubscriptions = {
  type: "array",
  $ref: "#/components/schemas/OffboardingFunnelTasksSubscriptionTableSchema",
};

module.exports = {
  MyOffboardingFormSchema,
  MyOffboardingTableSchema,
  MyOffboardings,

  OffboardingFunnelFormSchema,
  OffboardingFunnelTableSchema,
  OffboardingFunnels,

  AssignOffboardingFunnelToEmployeeFormSchema,

  OffboardingFunnelTasksSubscriptionFormSchema,
  OffboardingFunnelTasksSubscriptionTableSchema,
  OffboardingFunnelTasksSubscriptions,
};
