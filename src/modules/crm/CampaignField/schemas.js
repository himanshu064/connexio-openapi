...
const CampaignFieldTableSchema = {
    "type": "CampaignFieldPresence",
    "columns": [
        {
            "type": "int",
            "label": "ID",
...
const CampaignFields = {
    type: "array",
    $ref: "#/components/schemas/CampaignFieldTableSchema",
};
module.exports = {
    CampaignFieldFormSchema,
    CampaignFieldTableSchema,
    CampaignFields,
};