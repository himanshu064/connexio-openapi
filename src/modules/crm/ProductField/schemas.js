...
const ProductFieldTableSchema = {
    "type": "ProductFieldPresence",
    "columns": [
        {
            "type": "int",
            "label": "ID",
...
const ProductFields = {
    type: "array",
    $ref: "#/components/schemas/ProductFieldTableSchema",
};
module.exports = {
    ProductFieldFormSchema,
    ProductFieldTableSchema,
    ProductFields,
};