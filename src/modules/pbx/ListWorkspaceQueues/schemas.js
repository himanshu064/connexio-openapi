...
const ListWorkspaceQueueFormSchema = {
    "title": "",
    "type": "object",
    "properties": {
        "name": {
        ...
        "dial_timeout": {
            "type": "integer",
            "title": "Manual Dial Timeout",
            "help": "Number of seconds listening to dial before moving on.",
            "propertyOrder": 14
        }
    },
    "required": [
...
const ListWorkspaceQueueTableSchema = {
    "type": "WorkspaceQueue",
    "columns": [
        {
            "type": "int",
...
const ListWorkspaceQueues = {
    type: "array",
    $ref: "#/components/schemas/ListWorkspaceQueueTableSchema",
};
module.exports = {
    ListWorkspaceQueueFormSchema,
    ListWorkspaceQueueTableSchema,
    ListWorkspaceQueues,
};