...
const UserPhoneFormSchema = {
    ...
    "properties": {
        ...
        "user": {
            ...
            "help": "Choose user to associate with this phone.",
            "propertyOrder": 6
        }
    },
    "required": [
...
const UserPhones = {
    type: "array",
    $ref: "#/components/schemas/UserPhoneTableSchema",
};
module.exports = {
    UserPhoneFormSchema,
    UserPhoneTableSchema,
    UserPhones,
};