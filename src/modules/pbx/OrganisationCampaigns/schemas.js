const OrganisationCampaignFormSchema ={
    "title": "",
    "type": "object",
    "properties": {
        "name": {
...
const OrganisationCampaignTableSchema = {
...
const OrganisationCampaigns = {
    type: "array",
    $ref: "#/components/schemas/OrganisationCampaignTableSchema",
};
module.exports = {
    OrganisationCampaignFormSchema,
    OrganisationCampaignTableSchema,
