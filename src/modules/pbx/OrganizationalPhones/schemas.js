const OrganizationalPhoneFormSchema = {
    "title": "",
    "type": "object",
    "properties": {
        "name": {
        ...
        "password": {
            ...
            "title": "Password",
            "widget": "password",
            "help": "Must contain at least 16 and a maximum of 128 characters.",
            "minLength": "16",
            "propertyOrder": 3
        },
        "outboundDid": {
            ...
            "help": "outboundDid is a caller id while phone is making an outbound call (out of PBX)",
            "propertyOrder": 4
        },
        "outboundAllowed": {
            "type": "boolean",
            ...
            "widget": "checkbox",
            "help": "outboundAllowed is the toggle that allows a phone to make outbound calls or not",
            "propertyOrder": 5
        }
    },
    "required": [
...
const OrganizationalPhoneTableSchema = {
    "type": "OrganisationalPhone",
    "columns": [
        {
            "type": "int",
            "label": "ID",
...
const OrganizationalPhoneResources = {
    "active": "1",
    "outboundAllowed": "1"
}
const OrganizationalPhones = {
    type: "array",
    $ref: "#/components/schemas/OrganizationalPhoneTableSchema",
};
module.exports = {
    OrganizationalPhoneFormSchema,
    OrganizationalPhoneTableSchema,
    OrganizationalPhoneResources,
    OrganizationalPhones,
};